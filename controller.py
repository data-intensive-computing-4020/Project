...
if int(os.system("python generator.py {} table1.json table2.json".format(rows))) != 0:
    ...
    print(bcolors.OKBLUE + "Tables generated successfully" + bcolors.ENDC)
...
if int(os.system(
    ...
    print(bcolors.OKBLUE + "Naive join successfully" + bcolors.ENDC)
...
if int(os.system(
    ...
    print(bcolors.OKBLUE + "MPI cluster join successfully" + bcolors.ENDC)
...
if int(os.system(
        "python resultCheck.py NaiveJoin_result_R{}_N{}.json 0 MPIJoin_result_R{}_N{}.json 0 MRJoin_result_R{}_N{}.json".format(rows,nodes,rows,nodes,rows,nodes))) != 0:
